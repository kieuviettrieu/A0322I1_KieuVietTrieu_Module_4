...
public class BlogService implements IBlogService {
    ...
    @Override
    public Iterable<Blog> findAll(String name) {
    ...
    @Override
    public Optional<Blog> findByIdOp(Long id) {
        return blogRepository.findById(id);
    }

    @Override
    public Iterable<Blog> findAllByNameBlog(String name) {
        return blogRepository.findAllByTenBlogContaining(name);
    }
}
